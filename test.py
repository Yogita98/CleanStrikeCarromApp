...
class TestPlayGame(unittest.TestCase):
    def test_given_sample(self):
        ...
        """
        player_input =[2,1,1,2,1,2,2,4,6,1,1,6,4,1,2,1,6,2,2,6,1,1,1,1,1,1,3]
    ...
    def test_blackcoins_exhausted(self):
        ...
        """
        player_input =[1,2,1,6,1,1,1,6,1,1,6,1]
        result = playgame(player_input)
    ...
    def test_highest_player_greater_than_5_and_difference_greater_than_3(self):
        """
